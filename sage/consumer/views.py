...
def math(entities):
    ...
    api_url = str.format("http://api.wolframalpha.com/v2/query?appid=KYP3UW35R4EETYA3&input={}&format=image", urllib.quote_plus(math_request))

    return urllib2.urlopen(url=api_url).read()
